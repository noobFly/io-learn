 ...
 * <p>
 * 如果已经连接上的客户端非正常关闭输出流（shutdownOutput），则服务端异常
 * <p>
 * Exception in thread "main" java.lang.RuntimeException:
 * java.net.SocketException: Connection reset at
 * com.noob.learn.bio.ClientRequestHandler.run(ClientRequestHandler.java:50) at
 * com.noob.learn.bio.SocketServer.main(SocketServer.java:19) Caused by:
 * java.net.SocketException: Connection reset at
 ...
 * com.noob.learn.bio
 * .ClientRequestHandler.handleWithoutLineBreak(ClientRequestHandler.java:62) at
 * com.noob.learn.bio.ClientRequestHandler.run(ClientRequestHandler.java:46) ...
 * 1 more
 */
